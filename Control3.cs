...
//FirstPerson controller -------------------------------- (Does not use a rigidbody)
/* How to use:
1. Make an empty Gameobject - name it player
2. Add a character controller component
3. Position the camera so it is inside the player (or on top of it)
4. Make the camera a child of the Player object
...
public class Control3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!characterController.isGrounded)
        {
            ...
            kill_count.text = "Kill Count: " + kill_count.ToString();
        }
